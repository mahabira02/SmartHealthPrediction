  ...
  <div id="nav">
    <ul>
      ...
      <li><a href="appointmentdoctor.jsp">Patients Appointment</a></li>
       <li><a class="active" href="appointmentdetails.jsp">Appointment Details</a></li>
...
int srno=1;
PreparedStatement ps = con.prepareStatement("select * from appointment where hospitalid=?");
